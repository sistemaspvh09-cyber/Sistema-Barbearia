...
const EditarServiOCorteDegrad: React.FC = () => {
  return (
...
<button className="bg-primary-container text-on-primary font-bold px-8 py-3 rounded-xl shadow-[0_0_20px_rgba(200,255,0,0.2)] hover:scale-[1.02] transition-transform active:scale-95">Salvar Alterações</button>
</div>
</div>
</div>
...
export default EditarServiOCorteDegrad;
