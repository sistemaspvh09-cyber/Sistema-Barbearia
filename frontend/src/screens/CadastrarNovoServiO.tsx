...
const CadastrarNovoServiO: React.FC = () => {
  return (
...
<a className="flex items-center gap-3 text-[#A0A0A0] hover:text-white px-4 py-3 transition-all hover:bg-[#ffffff]/5 rounded-xl" href="#">
...
<div>
<h3 className="text-xl font-bold tracking-tight text-on-surface">Cadastrar Novo Serviço</h3>
...
<input className="w-full bg-surface-container-low border border-white/5 rounded-xl px-4 py-3 focus:ring-1 focus:ring-primary-fixed focus:border-primary-fixed text-on-surface placeholder:text-on-surface-variant/40 outline-none transition-all" placeholder="Ex: Corte Premium" type="text"/>
</div>
<div className="col-span-2 md:col-span-1 space-y-2">
...
<textarea className="w-full bg-surface-container-low border border-white/5 rounded-xl px-4 py-3 focus:ring-1 focus:ring-primary-fixed text-on-surface placeholder:text-on-surface-variant/40 outline-none transition-all resize-none" placeholder="Descreva os diferenciais deste serviço..." rows="3"></textarea>
</div>
<div className="col-span-2 md:col-span-1 space-y-2">
...
<input className="w-full bg-surface-container-low border border-white/5 rounded-xl pl-12 pr-4 py-3 focus:ring-1 focus:ring-primary-fixed text-on-surface placeholder:text-on-surface-variant/40 outline-none transition-all" placeholder="0,00" step="0.01" type="number"/>
</div>
</div>
<div className="col-span-2 md:col-span-1 space-y-2">
...
<button className="bg-primary-container text-on-primary font-bold px-8 py-3 rounded-xl shadow-[0_0_20px_rgba(200,255,0,0.2)] hover:scale-[1.02] transition-transform active:scale-95">
                    Salvar Serviço
                </button>
</div>
</div>
...
export default CadastrarNovoServiO;
