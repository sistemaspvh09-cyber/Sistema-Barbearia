...
const ConfiguraODeServiOsAtualizada: React.FC = () => {
  return (
...
<h3 className="text-xl font-bold text-white mt-2 group-hover:text-primary-container transition-colors">Corte Degradê</h3>
...
<p className="text-lg font-black text-white leading-none">Corte Degradê</p>
</div>
</div>
<div className="bg-surface-container-low p-4 rounded-2xl border border-white/5 flex items-center gap-4">
...
export default ConfiguraODeServiOsAtualizada;
